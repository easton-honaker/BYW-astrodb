...
| ❗️ <ins>spectral_type_string</ins> | Spectral type string | string | 20 |  | src.spType  |
| ❗️ <ins>spectral_type_code</ins> | Numeric code corresponding to spectral type. 60 = M0, 69 = M9, 70 = L0, 80 = T0, 90 = Y0 | double |  |  | meta.code;src.spType  |
| spectral_type_error | Uncertainty of the spectral type value | double |  |  | stat.error;src.spType  |
| ❗️ <ins>regime</ins> | Spectral type regime; links to Regimes table | string | 30 |  | meta.id  |
